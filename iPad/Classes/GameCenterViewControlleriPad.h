//
//  GameCenterViewControlleriPad.h
//  eyeDoubleMatch
//
...
@interface GameCenterViewControlleriPad : UIViewController  <GKLeaderboardViewControllerDelegate, GKAchievementViewControllerDelegate> {
